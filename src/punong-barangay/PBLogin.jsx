...
export default function PBLogin() {
  ...
  function handleSubmit(ev) {
    ...
    setLoading(true);
    setTimeout(() => {
      if (email === PB_CREDENTIALS.email && password === PB_CREDENTIALS.password) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Star size={15} color="#86EFAC" />
          <span style={{ fontWeight: 600, color: "#86EFAC" }}>Punong Barangay</span>
          <span style={{ color: "rgba(255,255,255,0.55)" }}>· Barangay Portal</span>
        </div>
