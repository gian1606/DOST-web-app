      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <div>
              <div className="font-semibold text-text-primary leading-tight" style={{ fontSize: 13 }}>Hon. Juan dela Cruz</div>
              <div className="text-text-muted leading-tight" style={{ fontSize: 11 }}>Punong Barangay</div>
            </div>
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-1 rounded-xl overflow-hidden" style={{ top: "100%", minWidth: 180, background: "#fff", border: "1px solid #E5E7EB", boxShadow: "0 8px 24px rgba(0,0,0,0.10)", zIndex: 50 }}>
              <button
                onClick={() => { setProfileOpen(false); navigate("/pb/settings"); }}
