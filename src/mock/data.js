...
// capacity_tier:   'Tier 1' (120–240L) | 'Tier 2' (660L) | 'Tier 3' (1100L) | 'Tier 4' (custom m³)
// waste_type:      'Biodegradable' | 'Non-Recyclable' | 'Recyclable'
// barangay_code:   "<BARANGAY>-<SEQ>" — used in QR payload
// cluster_id:      'SOLID-EAST' (default for Batangas City north zone)
// coordinates:     { lat, lng } — WGS-84 real coordinates
// posX / posY:     0–1 percentage values for the internal map canvas
export const BINS = [
  { id: "b1",  name: "Bin A-01", street: "P. Burgos St.",       barangay: "Alangilan",        barangay_code: "ALANGILAN-01",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 1", capacity_volume_liters: 240,  waste_type: "Biodegradable",   sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7565, lng: 121.0583 }, status: "full",      reportedBy: "resident_01", timeReported: "2025-05-18T06:12:00Z", posX: 0.28, posY: 0.22 },
  { id: "b2",  name: "Bin A-02", street: "Rizal Ave.",          barangay: "Alangilan",        barangay_code: "ALANGILAN-02",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 2", capacity_volume_liters: 660,  waste_type: "Recyclable",      sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7571, lng: 121.0591 }, status: "ok",        reportedBy: null,          timeReported: null,                   posX: 0.32, posY: 0.30 },
  { id: "b3",  name: "Bin B-01", street: "Evangelista St.",     barangay: "Cuta",             barangay_code: "CUTA-01",        cluster_id: "SOLID-EAST", capacity_tier: "Tier 1", capacity_volume_liters: 240,  waste_type: "Non-Recyclable",  sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7512, lng: 121.0548 }, status: "full",      reportedBy: "resident_02", timeReported: "2025-05-18T07:45:00Z", posX: 0.45, posY: 0.18 },
  { id: "b4",  name: "Bin B-02", street: "Mabini St.",          barangay: "Cuta",             barangay_code: "CUTA-02",        cluster_id: "SOLID-EAST", capacity_tier: "Tier 3", capacity_volume_liters: 1100, waste_type: "Biodegradable",   sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7508, lng: 121.0555 }, status: "collected", reportedBy: "resident_03", timeReported: "2025-05-18T05:30:00Z", posX: 0.50, posY: 0.25 },
  { id: "b5",  name: "Bin C-01", street: "Kumintang Road",      barangay: "Kumintang Ibaba",  barangay_code: "KUMIBABA-01",    cluster_id: "SOLID-EAST", capacity_tier: "Tier 2", capacity_volume_liters: 660,  waste_type: "Recyclable",      sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7620, lng: 121.0610 }, status: "full",      reportedBy: "resident_04", timeReported: "2025-05-18T08:00:00Z", posX: 0.60, posY: 0.35 },
  { id: "b6",  name: "Bin C-02", street: "Kumintang Road",      barangay: "Kumintang Ibaba",  barangay_code: "KUMIBABA-02",    cluster_id: "SOLID-EAST", capacity_tier: "Tier 1", capacity_volume_liters: 240,  waste_type: "Non-Recyclable",  sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7626, lng: 121.0618 }, status: "ok",        reportedBy: null,          timeReported: null,                   posX: 0.65, posY: 0.40 },
  { id: "b7",  name: "Bin D-01", street: "Ilaya Rd.",           barangay: "Kumintang Ilaya",  barangay_code: "KUMIILAYA-01",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 4", capacity_volume_liters: null, waste_type: "Biodegradable",   sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7645, lng: 121.0570 }, status: "missed",    reportedBy: "resident_05", timeReported: "2025-05-17T14:00:00Z", posX: 0.70, posY: 0.28 },
  { id: "b8",  name: "Bin D-02", street: "Ilaya Rd.",           barangay: "Kumintang Ilaya",  barangay_code: "KUMIILAYA-02",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 2", capacity_volume_liters: 660,  waste_type: "Recyclable",      sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7651, lng: 121.0577 }, status: "full",      reportedBy: "resident_06", timeReported: "2025-05-18T09:10:00Z", posX: 0.75, posY: 0.32 },
  { id: "b9",  name: "Bin E-01", street: "Libjo Main St.",      barangay: "Libjo",            barangay_code: "LIBJO-01",       cluster_id: "SOLID-EAST", capacity_tier: "Tier 1", capacity_volume_liters: 240,  waste_type: "Non-Recyclable",  sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7480, lng: 121.0532 }, status: "ok",        reportedBy: null,          timeReported: null,                   posX: 0.38, posY: 0.55 },
  { id: "b10", name: "Bin E-02", street: "Libjo Main St.",      barangay: "Libjo",            barangay_code: "LIBJO-02",       cluster_id: "SOLID-EAST", capacity_tier: "Tier 3", capacity_volume_liters: 1100, waste_type: "Biodegradable",   sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7486, lng: 121.0540 }, status: "full",      reportedBy: "resident_07", timeReported: "2025-05-18T07:00:00Z", posX: 0.42, posY: 0.60 },
  { id: "b11", name: "Bin F-01", street: "Pallocan West Ave.",  barangay: "Pallocan West",    barangay_code: "PALLOCANW-01",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 2", capacity_volume_liters: 660,  waste_type: "Recyclable",      sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7530, lng: 121.0496 }, status: "collected", reportedBy: "resident_08", timeReported: "2025-05-18T06:00:00Z", posX: 0.22, posY: 0.65 },
  { id: "b12", name: "Bin F-02", street: "Pallocan West Ave.",  barangay: "Pallocan West",    barangay_code: "PALLOCANW-02",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 1", capacity_volume_liters: 240,  waste_type: "Non-Recyclable",  sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7536, lng: 121.0503 }, status: "full",      reportedBy: "resident_09", timeReported: "2025-05-18T08:30:00Z", posX: 0.18, posY: 0.70 },
  { id: "b13", name: "Bin G-01", street: "Pallocan East Rd.",   barangay: "Pallocan East",    barangay_code: "PALLOCANE-01",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 1", capacity_volume_liters: 240,  waste_type: "Biodegradable",   sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7558, lng: 121.0625 }, status: "ok",        reportedBy: null,          timeReported: null,                   posX: 0.55, posY: 0.68 },
  { id: "b14", name: "Bin G-02", street: "Pallocan East Rd.",   barangay: "Pallocan East",    barangay_code: "PALLOCANE-02",   cluster_id: "SOLID-EAST", capacity_tier: "Tier 3", capacity_volume_liters: 1100, waste_type: "Recyclable",      sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7563, lng: 121.0632 }, status: "full",      reportedBy: "resident_10", timeReported: "2025-05-18T09:45:00Z", posX: 0.58, posY: 0.72 },
  { id: "b15", name: "Bin H-01", street: "Sta. Rita Road",      barangay: "Sta. Rita Karsada",barangay_code: "STARITA-01",     cluster_id: "SOLID-EAST", capacity_tier: "Tier 2", capacity_volume_liters: 660,  waste_type: "Non-Recyclable",  sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7682, lng: 121.0644 }, status: "missed",    reportedBy: "resident_11", timeReported: "2025-05-17T16:00:00Z", posX: 0.80, posY: 0.60 },
  { id: "b16", name: "Bin H-02", street: "Sta. Rita Road",      barangay: "Sta. Rita Karsada",barangay_code: "STARITA-02",     cluster_id: "SOLID-EAST", capacity_tier: "Tier 4", capacity_volume_liters: null, waste_type: "Biodegradable",   sticker_dimensions: "15cm x 15cm", coordinates: { lat: 13.7688, lng: 121.0651 }, status: "full",      reportedBy: "resident_12", timeReported: "2025-05-18T10:00:00Z", posX: 0.84, posY: 0.65 },
];
