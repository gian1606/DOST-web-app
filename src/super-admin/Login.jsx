  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ maxWidth: 480, borderRadius: 16, padding: 40, boxShadow: "0 8px 24px rgba(0,0,0,0.18)" }}
      >
        {/* Seal */}
        <img src="/Batangas_logo.png" alt="Batangas City Seal" className="mb-4" style={{ width: 80, height: 80, objectFit: "contain" }} />

        {/* Wordmark */}
        <div className="font-bold text-text-primary text-center" style={{ fontSize: 28 }}>BE-SMART</div>
        <div className="text-center mt-1 mb-5" style={{ fontSize: 12, color: "#388E3C", maxWidth: 320, lineHeight: 1.5 }}>
          Batangas Environmental Segregation, Monitoring,<br />Analytics &amp; Rewards Technology
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4" noValidate>
          ...
          <div className="flex flex-col gap-1">
            <label className="font-medium text-text-primary" style={{ fontSize: 13 }}>Email Address</label>
            <input
              type="email"
              value={email}
              ...
              style={{ fontSize: 14, border: errors.email ? "1.5px solid #DC2626" : "1.5px solid #E5E7EB", background: "#F9FAFB" }}
              onFocus={(e) => (e.target.style.borderColor = "#2E7D32")}
              onBlur={(e)  => (e.target.style.borderColor = errors.email ? "#DC2626" : "#E5E7EB")}
            />
            {errors.email && <span style={{ fontSize: 12, color: "#DC2626" }}>{errors.email}</span>}
          </div>

          {/* Password */}
          <div className="flex flex-col gap-1">
            <label className="font-medium text-text-primary" style={{ fontSize: 13 }}>Password</label>
            <div className="relative">
              <input
                ...
                style={{ fontSize: 14, border: errors.password ? "1.5px solid #DC2626" : "1.5px solid #E5E7EB", background: "#F9FAFB" }}
                onFocus={(e) => (e.target.style.borderColor = "#2E7D32")}
        ...
        {/* Security note */}
        <div className="flex items-center gap-1.5 mt-5" style={{ fontSize: 12, color: "#9CA3AF" }}>
          <Lock size={12} />
