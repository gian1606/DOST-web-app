...
const EMPTY_FORM = { name: "", captain: "", email: "", tempPassword: "" };
...
export default function BarangayManagement() {
  ...
  function handleDelete(id) { setBarangays((prev) => prev.filter((b) => b.id !== id)); setDeleteTarget(null); }
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)}
          className="rounded-lg px-3 py-2 outline-none font-medium"
